...
Enemy5::Enemy5(const CVector2D& p, bool flip) :Base(eType_Enemy) {
	//画像複製
	...
	Base(eType_ItemManeger)
{
	...
	for (int i = 0; i < 10; i++) {
		...
		//床か壁かを判定する
		if (t == 1) {
			Base::Add(new Enemy5(CVector2D(x * MAP_TIP_SIZE + 50, y * MAP_TIP_SIZE + 50), true));
		}
	}
}
static TexAnim enemy5IdleD[] = {
...
static TexAnim enemy5Damage[] = {
	{ 17,1 },
	{ 16,1 },
};
static TexAnim enemy5Down[] = {
	{ 13,2 },
	{ 18,2 },
	{ 13,2 },
	{ 18,2 },
};
TexAnimData Enemy5_anim_data[] = {
	ANIMDATA(enemy5IdleD),
	ANIMDATA(enemy5IdleU),
	ANIMDATA(enemy5IdleR),
	ANIMDATA(enemy5IdleL),
	ANIMDATA(enemy5Attack01),
	ANIMDATA(enemy5Attack01),
	ANIMDATA(enemy5Attack01),
	ANIMDATA(enemy5Attack01),
	ANIMDATA(enemy5Damage),
	ANIMDATA(enemy5Down),
};
//Enemy3